...
public class NaverMap implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		/*
		 * 키:s5dglIOMdHJrlvFR882GwvvFQPeN4hQUeJhDWYBG
		 * 
		 * 아이디:jryr9el6xj
		 * 
		 * 이름: JavaTPC-230726
	...
	public void map_service(AddressVO vo) {
		...
		try {
            ...
            con.setRequestMethod("GET");
            con.setRequestProperty("X-NCP-APIGW-API-KEY-ID", "jryr9el6xj");
            con.setRequestProperty("X-NCP-APIGW-API-KEY", "s5dglIOMdHJrlvFR882GwvvFQPeN4hQUeJhDWYBG");  
            int responseCode = con.getResponseCode();
            BufferedReader br;            
